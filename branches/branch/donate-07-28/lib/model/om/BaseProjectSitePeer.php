...
abstract class BaseProjectSitePeer {
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = ProjectSitePeer::getTableMap();
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProjectSitePeer::SITE_ID);

		$criteria->addSelectColumn(ProjectSitePeer::SITE_NAME);

		$criteria->addSelectColumn(ProjectSitePeer::PROVINCE);

		$criteria->addSelectColumn(ProjectSitePeer::CITY);

		$criteria->addSelectColumn(ProjectSitePeer::DISTRICT);

		$criteria->addSelectColumn(ProjectSitePeer::DISCRIPTION);
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$rs = ProjectSitePeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ProjectSitePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	public static function doValidate(ProjectSite $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ProjectSitePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ProjectSitePeer::TABLE_NAME);
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(ProjectSitePeer::SITE_ID, $pk);


		$v = ProjectSitePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(ProjectSitePeer::SITE_ID, $pks, Criteria::IN);
			$objs = ProjectSitePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
