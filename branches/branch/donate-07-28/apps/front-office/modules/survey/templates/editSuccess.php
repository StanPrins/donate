...
<h1><?php echo $survey->getStudent()->getName() ?>的调查信息</h1>
...
<?php echo submit_tag('提交') ?>
  &nbsp;<?php echo link_to('删除', 'survey/delete?survey_id='.$survey->getSurveyId(), 'post=true&confirm=Are you sure?') ?>
  &nbsp;<?php echo link_to('返回', 'survey/show?survey_id='.$survey->getSurveyId()) ?>
</form>
</div>
</div>
