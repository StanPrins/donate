...
<?php if ($student->getStudentId()): ?>
  &nbsp;<?php echo link_to('删除', 'student/delete?student_id='.$student->getStudentId(), 'post=true&confirm=Are you sure?') ?>
  &nbsp;<?php echo link_to('取消', 'student/show?student_id='.$student->getStudentId()) ?>
<?php else: ?>
  &nbsp;<?php echo link_to('取消', 'student/list') ?>
<?php endif; ?>
</form>
</div>
</div>