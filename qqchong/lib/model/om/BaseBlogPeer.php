...
abstract class BaseBlogPeer {
	...
	const RECOMMEND = 'blog.RECOMMEND';

	
	const RDTIME = 'blog.RDTIME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Title', 'Content', 'Recommend', 'Rdtime', 'CreatedAt', ),
		BasePeer::TYPE_COLNAME => array (BlogPeer::ID, BlogPeer::USER_ID, BlogPeer::TITLE, BlogPeer::CONTENT, BlogPeer::RECOMMEND, BlogPeer::RDTIME, BlogPeer::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'title', 'content', 'recommend', 'rdtime', 'created_at', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Title' => 2, 'Content' => 3, 'Recommend' => 4, 'Rdtime' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (BlogPeer::ID => 0, BlogPeer::USER_ID => 1, BlogPeer::TITLE => 2, BlogPeer::CONTENT => 3, BlogPeer::RECOMMEND => 4, BlogPeer::RDTIME => 5, BlogPeer::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'title' => 2, 'content' => 3, 'recommend' => 4, 'rdtime' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BlogPeer::RDTIME);
