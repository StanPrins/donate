...
<li><span class="date"><?php echo $hot->getCreatedAt()?></span><?php echo link_to($hot->getTitle(),'blog/show?id='.$hot->getId())?>( <?php echo $hot->getUser()->getNickname().'--'.$hot->countComments().' comments'?> )</li>
</ul>
<?php endforeach;?>
<div class="moreInfo">
<ul class="moreInfo">
...
<?php echo link_to($blog->getTitle(),'blog/show?id='.$blog->getId())?>( <?php echo $blog->getUser()->getNickname().'--'.$blog->countComments().' comments'?> )</li>
</ul>
<?php endforeach;?>
<div class="moreInfo">
<ul class="moreInfo">
...
<?php echo link_to($topic->getTitle(),'topic/show?id='.$topic->getId())?>( <?php echo $topic->getUser()->getNickname().'--'.$topic->countComments().' comments'?> )</li>
</ul>
<?php endforeach;?>
<div class="moreInfo">
<ul class="moreInfo">
