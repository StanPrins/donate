...
else if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  $validators['sfRegexValidator_username'] = new sfRegexValidator();
  $validators['sfRegexValidator_username']->initialize($context, array (
  'match' => true,
  'match_error' => 'Must end with @ericsson.com',
  'pattern' => '/@ericsson.com$/i',
));
  ...
  $validators['sfPropelUniqueValidator_nickname'] = new sfPropelUniqueValidator();
  $validators['sfPropelUniqueValidator_nickname']->initialize($context, array (
  'class' => 'User',
  'column' => 'nickname',
  'unique_error' => 'The nickname was Registered',
));
  ...
  $validatorManager->registerValidator('nickname', $validators['sfPropelUniqueValidator_nickname'], null);
