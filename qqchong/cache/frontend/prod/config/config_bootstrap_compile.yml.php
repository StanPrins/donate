...
sfConfig::add(array(
  ...
  'sf_validation_error_prefix' => ' &uarr;&nbsp;',
  'sf_validation_error_suffix' => ' &nbsp;&uarr;',
...
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "magic_quotes_gpc" key is better set to "false" (current value is "\'\'" - php.ini location: "C:\wamp\bin\apache\Apache2.2.11\bin\php.ini").');
}
if (ini_get('register_globals') != false)
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "register_globals" key is better set to "false" (current value is "\'\'" - php.ini location: "C:\wamp\bin\apache\Apache2.2.11\bin\php.ini").');
}
if (ini_get('session.auto_start') != false)
{
  sfLogger::getInstance()->warning('{sfPhpConfigHandler} php.ini "session.auto_start" key is better set to "false" (current value is "\'0\'" - php.ini location: "C:\wamp\bin\apache\Apache2.2.11\bin\php.ini").');
}
