...
<?php echo link_to(image_tag('admin_db/first.png'), 'remit/'.$page_to_link.'?page='.$pager->getFirstPage()) ?>
<?php echo link_to(image_tag('admin_db/previous.png'), 'remit/'.$page_to_link.'?page='.$pager->getPreviousPage()) ?>
<?php $links = $pager->getLinks(); foreach ($links as $page): ?>
<?php echo ($page == $pager->getPage()) ? $page : link_to($page, 'remit/'.$page_to_link.'?page='.$page) ?>
<?php if ($page != $pager->getCurrentMaxLink()): ?><?php endif ?>
<?php endforeach ?>
<?php echo link_to(image_tag('admin_db/next.png'), 'remit/'.$page_to_link.'?page='.$pager->getNextPage()) ?>
<?php echo link_to(image_tag('admin_db/last.png'), 'remit/'.$page_to_link.'?page='.$pager->getLastPage()) ?>
...
<?php echo form_tag('remit/'.$page_to_link)?>
Jump to Page
