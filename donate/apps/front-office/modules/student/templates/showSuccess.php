...
<table>
  ...
  <tr>
    <td class="name">OFS ID：</td>
    <td class="content"><?php echo $student->getOfsId() ?></td>
  </tr>  
  <tr>
    <td class="name">昵称：</td>
  ...
  <tr>
    <td class="name">民族：</td>
    <td class="content"><?php echo $student->getRace() ?></td>
  </tr>  
  <tr>
    <td class="name">照片：</td>
    <td class="content">
  ...
  <tr>
    ...
    <td class="content"><?php echo $student->getConsignee() ?></td>
  </tr>
  <tr>
    <td class="name">收件人地址：</td>
    <td class="content"><?php echo $student->getConsigneeAddress() ?></td>
  </tr>
  <tr>
    <td class="name">收件人邮编：</td>
    <td class="content"><?php if ($student->getConsigneePostal()) echo $student->getConsigneePostal(); ?></td>
  </tr>      
  <tr>
